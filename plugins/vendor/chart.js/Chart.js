...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			 ...
			 */
			me.chart = me;
			me.controller = me; // chart.chart.business #inception
			...
			if (!context || !canvas) {
				...
				// the chart initialization but after setting basic chart / business properties that
 ...
 * since responsiveness is handled by the business.resize() method. The config is used
...
defaults._set('global', {
	legend: {
		...
		onClick: function(e, legendItem) {
			...
			// See business.isDatasetVisible comment
